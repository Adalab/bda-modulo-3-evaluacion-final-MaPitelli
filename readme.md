...
#### <img src="images/vsc_logo.png" alt="VS Code Logo" width="30"/> [Visual Studio Code](https://code.visualstudio.com/) Editor de código utilizado para escribir y depurar el código en Python.

#### <img src="images/jupyter_logo.png" alt="Jupyter Logo" width="30"/> [Jupyter Notebooks](https://jupyter.org/) En esta evaluación, se utilizaron archivos Jupyter Notebooks (extensión .ipynb) para la exploración interactiva de datos y la creación de gráficos.
